...
export function formatAtGranularity(time, granualarity) {
    switch (granualarity) {
        case 0:
...
export function formatTimeAtGranularity(time, granualarity) {
...
export function downloadPNGfromSVG(name, svgId) {
