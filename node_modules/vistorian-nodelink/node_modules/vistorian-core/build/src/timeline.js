...
import { WebGLElementQuery } from "./glutils";
export class Timeline {
    ...
    updateWithIds(minTimeId, maxTimeId) {
        ...
        let requiredTicks = Number.MAX_VALUE; // INIT?
        let t1, t2;
        ...
        if (this.tick_minGran_visible_prev != this.tick_minGran_visible) {
            ...
            this.timeLabels = this.webgl
                ...
                .filter((d, i) => {
                const visible = this.timeGranularities[i] >= this.tick_minGran_visible;
                return visible;
            })
                .append("text")
        ...
        this.timeLabels
            ...
            const visible = globalId >= this.minTimeId &&
