...
export declare function sortByPriority(s1: any, s2: any): number;
...
export declare function inBox(x: any, y: any, box: Box): boolean;
...
export declare function formatAtGranularity(time: any, granualarity: number): string | undefined;
...
export declare function formatTimeAtGranularity(time: Time, granualarity: number): number;
export declare function downloadPNGFromCanvas(name: string): void;
export declare function downloadPNGfromSVG(name: string, svgId: string): void;
...
export declare function getBlobFromSVGString(name: string, svgString: string, width: number, height: number, callback: (blob: any, name: string) => void, backgroundColor?: string): void;
export declare function getSVGString(svgNode: any): string;
export declare function exportPNG(canvas: any, name: string): void;
export declare function showMessage(message: string, timeout: any): void;
