...
export function loadDyson(url, callback) {
...
export function loadXML(url, callBack) {
    let d;
    let dataset;
 ...
 */
export function loadJson(url, callBack, dataName) {
    let d;
    let dataset;
    d3.json(url).then((data) => {
        if (!data)
...
export function loadJsonList(url, callBack) {
    let d;
    let dataset;
    d3.json(url).then((data) => {
        if (!data)
...
export function loadNCube(url, callBack) {
    let d;
    let dataset;
    d3.json(url).then((data) => {
        const nodeTable = [];
...
export function loadPajek(url, callBack) {
    let d;
    let dataset;
    $.get(url, (data) => {
...
export function loadMat(url, callBack) {
    let d;
    let dataset;
    $.get(url, (data) => {
        const lines = data.split("\n");
...
export function loadLinkList(url, callBack) {
    let d;
    let dataset;
    $.get(url, (data) => {
        const lines = data.split("\n");
...
export function loadMatrix(url, callBack) {
    let d;
    let dataset;
    $.get(url, (data) => {
        const lines = data.split("\n");
